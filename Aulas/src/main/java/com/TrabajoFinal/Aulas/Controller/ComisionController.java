...
public class ComisionController {
    ...
    @PostMapping
    public Comision guardar(@RequestBody ComisionResponseDTO profesorMateria) {
        return service.guardar(profesorMateria);
    }
    @PutMapping("/{id}")
    public Comision modificar(@PathVariable Integer id, @RequestBody ComisionResponseDTO profesorMateria) {
